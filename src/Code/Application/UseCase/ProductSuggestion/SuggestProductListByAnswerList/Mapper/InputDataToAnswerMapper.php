...
namespace App\Code\Application\UseCase\ProductSuggestion\SuggestProductListByAnswerList\Mapper;

use App\Code\Application\UseCase\ProductSuggestion\SuggestProductListByAnswerList\Data\AnswerData;
...
class InputDataToAnswerMapper
{
     ...
     */
    public function map(AnswerData $input): Answer
    {
